    ...
    <div class="section_tip first">
      ...
      <div class="grid">
        <div class="left">
          ...
          <div class="panel">
            <div class="top">
              <h5>Pubblicizza il tuo brand con l' <span class="strg">Email Marketing</span> integrato</h5>
              <div class="small">
        ...
        <div class="right">
          ...
          <div class="panel">
            <div class="top">
              <h5> Nuove funzionalità sempre in implementazione, prendendo spunto proprio dal <span class="strg">tuo modo di lavorare! </span> </h5>
            </div>
          </div>
        ...
        <div class="right">
          ...
          <div @click="nexts(2, 0)" class="panel">
            <div :class="slide_1_c == 0 ? 'up top' : 'top'">
              <h5>Gestisci comodamente su <span class="strg">WhatsApp</span> ordini e prenotazioni</h5>
              <div class="small">
            ...
            <p>La nostra dashboard si integra su WhatsApp per notificarti ogni ordine o prenotazione, e con un solo click decidi se annullare o confermare</p>
          </div>
        </div>
        <div class="left">
          <div @click="nexts(2, 1)" class="panel">
            <div :class="slide_1_c == 1 ? 'up top' : 'top'">
              ...
              <div class="small">
                ...
                <svg id="box" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-inboxes" viewBox="0 0 16 16">
